...
const Reset = () => {
  ...
  <div className='flex-1 gap-2 sm:gap-4 text-xs sm:text-sm flex flex-col justify-center items-center'>
    ...
    <input type="text" onChange={(e) => setEmail(e.target.value)} value={email} placeholder='Account Email' className='duration-300 border-b-2 border-solid border-white focus:border-cyan-300 outline-none text-slate-900 p-1 w-full max-w-[40ch]'/>
